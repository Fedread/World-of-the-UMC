...
define config.name = _("World of the UMC")
...
define build.name = "WorldoftheUMC"
...
define config.main_menu_music = "mein_menu.mp3"
...
define config.save_directory = "WorldoftheUMC-1701516644"
